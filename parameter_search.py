...
if __name__ == '__main__':
    ...
    features = ['Day', 'Minutes', 'Week'
           ...
           'Prev_4d_mean_cons', 'Prev_4w_mean_cons'] #'winddirection_10m', 'pressure_msl', 'surface_pressure', 'precipitation', 'snowfall', 'weathercode', 'cloudcover', 'cloudcover_low', 'cloudcover_mid', 'cloudcover_high', 'Consumption(Wh)', 'Week', 'Month', 'Day_of_year',
