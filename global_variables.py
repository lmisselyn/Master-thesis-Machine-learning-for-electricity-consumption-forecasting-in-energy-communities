...
wrapp_mape = {'XGB': {'01': ['relativehumidity_2m', 'dewpoint_2m', 'apparent_temperature', 'Prev_4d_mean_cons',
                            'Prev_4w_mean_cons'],
                      '02': ['Day', 'Weekend', 'apparent_temperature', 'windspeed_10m', 'Prev_4d_mean_cons'],
                      '03': ['Day', 'Weekend', 'windspeed_10m', 'Prev_4d_mean_cons', 'Prev_4w_mean_cons'],
                      '04': ['Minutes', 'relativehumidity_2m', 'shortwave_radiation', 'windspeed_10m',
                             'Prev_4d_mean_cons'],
                      '05': ['Day', 'Minutes', 'relativehumidity_2m', 'dewpoint_2m', 'windspeed_10m'],
                      '06': ['Day', 'dewpoint_2m', 'apparent_temperature', 'shortwave_radiation',
                             'Prev_4w_mean_cons'],
                      '07': ['Day', 'Weekend', 'dewpoint_2m', 'Prev_4d_mean_cons', 'Prev_4w_mean_cons'],
                      '08': ['Weekend', 'dewpoint_2m', 'apparent_temperature', 'shortwave_radiation',
                             'Prev_4d_mean_cons']},
              'SVM': {'01': ['Weekend', 'dewpoint_2m', 'windspeed_10m', 'Prev_4d_mean_cons',
                             'Prev_4w_mean_cons'],
                      '02': ['Day', 'Weekend', 'apparent_temperature', 'windspeed_10m', 'Prev_4d_mean_cons'],
                      '03': ['Day', 'Weekend', 'relativehumidity_2m', 'Prev_4d_mean_cons', 'Prev_4w_mean_cons'],
                      '04': ['Day', 'Minutes', 'Weekend', 'shortwave_radiation', 'windspeed_10m'],
                      '05': ['relativehumidity_2m', 'dewpoint_2m', 'apparent_temperature', 'Prev_4d_mean_cons',
                             'Prev_4w_mean_cons'],
                      '06': ['Day', 'dewpoint_2m', 'apparent_temperature', 'shortwave_radiation',
                             'Prev_4d_mean_cons'],
                      '07': ['Day', 'Weekend', 'apparent_temperature', 'Prev_4d_mean_cons', 'Prev_4w_mean_cons'],
                      '08': ['Day', 'Weekend', 'relativehumidity_2m', 'windspeed_10m', 'Prev_4d_mean_cons']},
              'RF': {'01': ['Minutes', 'dewpoint_2m', 'apparent_temperature', 'Prev_4d_mean_cons',
                            'Prev_4w_mean_cons'],
                     '02': ['Day', 'Weekend', 'apparent_temperature', 'windspeed_10m', 'Prev_4d_mean_cons'],
                     '03': ['Day', 'Weekend', 'relativehumidity_2m', 'windspeed_10m', 'Prev_4d_mean_cons'],
                     '04': ['Minutes', 'relativehumidity_2m', 'shortwave_radiation', 'windspeed_10m',
                            'Prev_4d_mean_cons'],
                     '05': ['Minutes', 'relativehumidity_2m', 'dewpoint_2m', 'Prev_4d_mean_cons',
                            'Prev_4w_mean_cons'],
                     '06': ['relativehumidity_2m', 'apparent_temperature', 'shortwave_radiation',
                            'windspeed_10m', 'Prev_4w_mean_cons'],
